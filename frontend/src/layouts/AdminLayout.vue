    ...
    <div class="gf-main">
      <aside class="gf-sidebar" :class="{ 'is-collapsed': isSidebarCollapsed }">
        <el-menu :default-active="activeMenu" :collapse="isSidebarCollapsed" router>
          <el-menu-item index="/admin/green-field">
          ...
          <el-menu-item index="/admin/leagues">
          ...
          <el-menu-item index="/admin/player-profile-updates">
...
import { HomeFilled, UserFilled, User, OfficeBuilding, Trophy, Calendar, Edit, ArrowLeft, ArrowRight } from '@element-plus/icons-vue'
...
const safeAvatar = computed(() => {
  ...
  if (!avatar || avatar === 'undefined' || avatar === 'null' || avatar === 'nan' || avatar.trim() === '') {
    return '/uploads/default/admin.jpg'
  }
  return avatar
})
